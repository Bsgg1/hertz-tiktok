...
type DouyinMessageChatRequest struct {
	...
	ToUserId   int64  `protobuf:"varint,2,opt,name=to_user_id,json=toUserId,proto3" form:"to_user_id" json:"to_user_id,omitempty" query:"to_user_id"`           // recipient's user id
...
type DouyinMessageChatResponse struct {
	...
	MessageList []*Message `protobuf:"bytes,3,rep,name=message_list,json=messageList,proto3" form:"message_list" json:"message_list,omitempty" query:"message_list"` // message list
}
...
type Message struct {
	...
	Id         int64  `protobuf:"varint,1,opt,name=id,proto3" form:"id" json:"id,omitempty" query:"id"`                                                         // message id
	ToUserId   int64  `protobuf:"varint,2,opt,name=to_user_id,json=toUserId,proto3" form:"to_user_id" json:"to_user_id,omitempty" query:"to_user_id"`           // The id of the recipient of the message
	FromUserId int64  `protobuf:"varint,3,opt,name=from_user_id,json=fromUserId,proto3" form:"from_user_id" json:"from_user_id,omitempty" query:"from_user_id"` // The id of the sender of the message
	Content    string `protobuf:"bytes,4,opt,name=content,proto3" form:"content" json:"content,omitempty" query:"content"`                                      // Message content
	CreateTime int64  `protobuf:"varint,5,opt,name=create_time,json=createTime,proto3" form:"create_time" json:"create_time,omitempty" query:"create_time"`     // message creation time
}
...
type DouyinMessageActionRequest struct {
	...
	Token      string `protobuf:"bytes,1,opt,name=token,proto3" form:"token" json:"token,omitempty" query:"token"`                                          // User authentication token
	ToUserId   int64  `protobuf:"varint,2,opt,name=to_user_id,json=toUserId,proto3" form:"to_user_id" json:"to_user_id,omitempty" query:"to_user_id"`       // user id of the recipient
	ActionType int32  `protobuf:"varint,3,opt,name=action_type,json=actionType,proto3" form:"action_type" json:"action_type,omitempty" query:"action_type"` // 1-Send a message
	Content    string `protobuf:"bytes,4,opt,name=content,proto3" form:"content" json:"content,omitempty" query:"content"`                                  // Message content
}
...
var file_message_proto_rawDesc = []byte{
	...
	0x65, 0x2f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x42, 0x21, 0x5a, 0x1f, 0x74, 0x69, 0x6b,
