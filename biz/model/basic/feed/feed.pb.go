...
type DouyinFeedRequest struct {
	...
	LatestTime int64 `protobuf:"varint,1,opt,name=latest_time,json=latestTime,proto3" form:"latest_time" json:"latest_time,omitempty" query:"latest_time"` // Optional, limit the time stamp of the latest submission of the returned video, accurate to the second
...
type DouyinFeedResponse struct {
	...
	NextTime   int64           `protobuf:"varint,4,opt,name=next_time,json=nextTime,proto3" form:"next_time" json:"next_time,omitempty" query:"next_time"` // publish the earliest time as the latest time in the next request
}
...
var file_feed_proto_rawDesc = []byte{
	...
	0x6e, 0x2f, 0x66, 0x65, 0x65, 0x64, 0x2f, 0x42, 0x1d, 0x5a, 0x1b, 0x74, 0x69, 0x6b, 0x74, 0x6f,
	0x6b, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x62, 0x61, 0x73, 0x69,
