...
type DouyinUserRegisterResponse struct {
	...
	Token      string `protobuf:"bytes,4,opt,name=token,proto3" form:"token" json:"token,omitempty" query:"token"`                      // user authentication token
}
...
type DouyinUserLoginRequest struct {
	...
	Username string `protobuf:"bytes,1,opt,name=username,proto3" form:"username" json:"username,omitempty" query:"username"` // Login Username
	Password string `protobuf:"bytes,2,opt,name=password,proto3" form:"password" json:"password,omitempty" query:"password"` // login password
}
...
var file_user_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x2f, 0x42, 0x1d, 0x5a, 0x1b, 0x74, 0x69, 0x6b,
