...
type DouyinFavoriteActionRequest struct {
	...
	VideoId    int64  `protobuf:"varint,2,opt,name=video_id,json=videoId,proto3" form:"video_id" json:"video_id,omitempty" query:"video_id"`                // video id
	ActionType int32  `protobuf:"varint,3,opt,name=action_type,json=actionType,proto3" form:"action_type" json:"action_type,omitempty" query:"action_type"` // 1-like, 2-unlike
}
...
type DouyinFavoriteListRequest struct {
	...
	Token  string `protobuf:"bytes,2,opt,name=token,proto3" form:"token" json:"token,omitempty" query:"token"` // authentication token
}
...
type DouyinFavoriteListResponse struct {
	...
	StatusCode int32           `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" form:"status_code" json:"status_code" query:"status_code"`     // 0 - success, other values - failure
	StatusMsg  string          `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" form:"status_msg" json:"status_msg,omitempty" query:"status_msg"` // status description
	VideoList  []*common.Video `protobuf:"bytes,3,rep,name=video_list,json=videoList,proto3" form:"video_list" json:"video_list,omitempty" query:"video_list"` // list of videos liked by users
}
...
var file_favorite_proto_rawDesc = []byte{
	...
	0x42, 0x24, 0x5a, 0x22, 0x74, 0x69, 0x6b, 0x74, 0x6f, 0x6b, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d,
