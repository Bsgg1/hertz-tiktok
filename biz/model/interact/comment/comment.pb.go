...
type DouyinCommentActionRequest struct {
	...
	ActionType  int32  `protobuf:"varint,3,opt,name=action_type,json=actionType,proto3" form:"action_type" json:"action_type,omitempty" query:"action_type"`     // 1- Post a comment, 2- Delete a comment
	CommentText string `protobuf:"bytes,4,opt,name=comment_text,json=commentText,proto3" form:"comment_text" json:"comment_text,omitempty" query:"comment_text"` // Comment content filled in by users，when action type=1
	CommentId   int64  `protobuf:"varint,5,opt,name=comment_id,json=commentId,proto3" form:"comment_id" json:"comment_id,omitempty" query:"comment_id"`          // The id of the comment to delete，when action type=1
}
...
type DouyinCommentActionResponse struct {
	...
	Comment    *Comment `protobuf:"bytes,3,opt,name=comment,proto3" form:"comment" json:"comment,omitempty" query:"comment"`                            // return the comment content, no need to re-pull the entire list
}
...
type Comment struct {
	...
	Id         int64        `protobuf:"varint,1,opt,name=id,proto3" form:"id" json:"id,omitempty" query:"id"`                                                    // video comment id
	User       *common.User `protobuf:"bytes,2,opt,name=user,proto3" form:"user" json:"user,omitempty" query:"user"`                                             // comment user information
	Content    string       `protobuf:"bytes,3,opt,name=content,proto3" form:"content" json:"content,omitempty" query:"content"`                                 // comment
	CreateDate string       `protobuf:"bytes,4,opt,name=create_date,json=createDate,proto3" form:"create_date" json:"create_date,omitempty" query:"create_date"` // comment publication date, format mm-dd
}
...
var file_comment_proto_rawDesc = []byte{
	...
	0x5a, 0x21, 0x74, 0x69, 0x6b, 0x74, 0x6f, 0x6b, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f, 0x64,
